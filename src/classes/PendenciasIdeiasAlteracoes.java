...
public class PendenciasIdeiasAlteracoes {
    ...
    *** MATER O BANCO PRODUÇÃO COM DADOS REAIS. TESTES USAR O BANCO TREINAMENTO
    ...
    PROBLEMAS
    - PROBLEMA PARA TRAZER O TREINO MAIS RECENTE. QUANDO ALUNO TEM UM TREINO VENCIDO E E FEITO UM TREINO NOVO, AINDA ESTA TRAZENDO O ANTIGO.(TELALISTAALUNOSFREQUENTES)
    */
